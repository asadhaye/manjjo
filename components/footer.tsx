    ...
    <footer className="bg-[#1a1a1a] text-white py-10 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex flex-col items-center gap-4 mb-8">
          <a
            href="https://maps.google.com/?q=24+D+Block+Rd,+Block+D+Punjab+CHS,+Lahore,+Pakistan"
            target="_blank"
        ...
        <div className="flex justify-center gap-6 mb-8">
          <a
            href="https://www.facebook.com/manjoobyzamzam/"
            target="_blank"
            rel="noopener noreferrer"
          ...
          <a
            href="https://www.instagram.com/manjoobyzamzam"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center justify-center w-10 h-10 rounded-full bg-white/10 hover:bg-white/20 transition-colors"
